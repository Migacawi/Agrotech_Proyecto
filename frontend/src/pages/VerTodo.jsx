            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '8px', paddingBottom: '20px' }}>
              <button
                ...
                style={{
                  ...
                  border: '1px solid #74e2d7', background: 'transparent',
                  color: '#74e2d7', cursor: pagina === 1 ? 'not-allowed' : 'pointer',
              ...
              <button
                ...
                style={{
                  padding: '8px 14px', borderRadius: '8px',
                  border: '1px solid #74e2d7', background: 'transparent',
                  color: '#74e2d7', cursor: pagina === totalPaginas ? 'not-allowed' : 'pointer',
